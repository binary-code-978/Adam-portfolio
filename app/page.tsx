    ...
    <>
      ...
      <main className="mx-auto max-w-6xl px-5 py-10 sm:px-8 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-3 md:[grid-auto-rows:minmax(90px,auto)]">
          ...
          <EducationCard className="md:col-span-3 md:row-span-3" index={6} />
          <LeadershipCard className="md:col-span-3 md:row-span-2" index={7} />
        ...
        <div className="mt-3 grid grid-cols-1 md:grid-cols-6 gap-3 md:[grid-auto-rows:minmax(90px,auto)]">
          ...
          <ContactCard id="contact" className="md:col-span-6 md:row-span-2" index={11} />
        </div>
